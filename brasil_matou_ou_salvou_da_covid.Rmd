...
mort_pop_tidy %>% 
  select(continente, pais, media_mortos_por_milhao, mortes_por_milhao, dif_media_mortes_por_milhao, matou_ou_salvou, resultado) %>% 
  ...
  before = TRUE) %>%
  formatStyle(columns = 1:7, fontSize = '130%')
...
>### __Conclusão:__ Em todos cenários o Brasil "matou por Covid", e muito. Não fez o dever de casa. Como um estudante negligente, repetirá de ano, década, século.   